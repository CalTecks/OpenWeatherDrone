...
public class GrassController : MonoBehaviour {
    ...
    private float grassAreaWidth;
    private float grassAreaHeight;
    ...
    void Awake () {
        // schaal van grasgebied aanpassen naar grootte ondergrond
        grassAreaWidth = 10 * transform.localScale.x;
        grassAreaHeight = 10 * transform.localScale.z;
        float grassAmount = grassAreaHeight * grassAreaWidth / 50f;
        grassNumber = (int)grassAmount;
        ground = transform;
